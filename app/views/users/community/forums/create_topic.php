    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="<?php echo URLROOT; ?>/community/createTopic" method="post" novalidate>
                        <div class="mb-3">
                            <label for="title" class="form-label"><i class="bi bi-type-h1 me-1"></i> Topic Title</label>
                            <input type="text" class="form-control <?php echo (!empty($data['title_err'])) ? 'is-invalid' : ''; ?>" id="title" name="title" value="<?php echo $data['title_topic'] ?? ''; ?>" placeholder="Enter a descriptive title">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control <?php echo (!empty($data['content_err'])) ? 'is-invalid' : ''; ?>" id="content" name="content" rows="10" placeholder="Describe your topic in detail"><?php echo $data['content'] ?? ''; ?></textarea>
                            <div class="invalid-feedback">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?php echo URLROOT; ?>/community/forums" class="btn btn-outline-secondary">Cancel</a>
                            <button type="submit" class="btn btn-primary" id="submit-topic">Create Topic</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script src="<?php echo URLROOT; ?>/public/js/forum-validation.js"></script>
<!-- Include form progress script -->
