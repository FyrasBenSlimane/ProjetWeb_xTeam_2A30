    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        :root {
            ...
            /* Primary colors - Changed to Fiverr-inspired green and minimalist scheme */
            --primary-color: #1dbf73; /* Changed to Fiverr green */
            --primary-light: #2ecb80; /* Lighter green */
            --primary-lighter: #e9f7f0; /* Very light green background */
            --primary-dark: #18a667; /* Darker green */
            
            /* Secondary colors - Changed to neutral dark for minimalist look */
            --secondary-color: #222325; /* Dark gray/black */
            --secondary-light: #404145; /* Lighter dark */
            --secondary-lighter: #f1f1f2; /* Very light gray background */
            --secondary-dark: #0e0e10; /* Near black */
            
            /* Gray shades - more refined, softer grays */
            --gray-50: #fafafa;
            --gray-100: #f5f5f5;
            --gray-200: #e9e9e9;
            --gray-300: #d9d9d9;
            ...
            /* Accent colors - More muted and professional */
            --accent-purple: #74767e; /* Changed to more neutral gray */
            --accent-purple-light: #d9d9dc;
            --accent-purple-lighter: #f5f5f7;
            
            --accent-pink: #62646a; /* Changed to more neutral gray */
            --accent-pink-light: #d6d7d9;
            --accent-pink-lighter: #f6f6f7;
            
            --accent-orange: #404145; /* Changed to more neutral dark */
            --accent-orange-light: #cfcfd1;
            --accent-orange-lighter: #f4f4f5;
            
            --accent-red: #F04438; /* Keeping red for alerts/errors */
            --accent-red-light: #FDA29B;
            --accent-red-lighter: #FEF3F2;
            
            --accent-green: #1dbf73; /* Same as primary */
            --accent-green-light: #A6F4C5;
            --accent-green-lighter: #ECFDF3;
            ...
            --primary-light-transparent: rgba(53, 99, 233, 0.1);
            --secondary-light-transparent: rgba(0, 169, 162, 0.1);
            --warning-light-transparent: rgba(247, 144, 9, 0.1);
            --danger-light-transparent: rgba(240, 68, 56, 0.1);
            --purple-light-transparent: rgba(105, 65, 198, 0.1);
            --teal-light-transparent: rgba(0, 169, 162, 0.1);
            ...
            --container-padding-x: 1rem;  /* 16px default padding */
            --container-padding-x-sm: 1.5rem; /* 24px for small screens */
            --container-padding-x-lg: 2rem; /* 32px for large screens */
        ...
        .bg-success-light { background-color: var(--accent-green-lighter) !important; }
        .bg-danger-light { background-color: var(--accent-red-lighter) !important; }
        .bg-warning-light { background-color: var(--accent-orange-lighter) !important; }
        .bg-info-light { background-color: var(--primary-lighter) !important; }
