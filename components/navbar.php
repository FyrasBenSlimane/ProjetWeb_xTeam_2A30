...
[data-bs-theme="dark"] .navbar.scrolled .admin-link {
    color: rgba(210, 225, 245, 0.8);
}

[data-bs-theme="dark"] .navbar.scrolled .admin-link:hover {
    color: #A8C8E8;
}
...
<nav class="navbar navbar-expand-lg">
    <div class="navbar-container">
        <a class="navbar-brand" href="/web">LenSi</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link admin-link" href="/web/admin/login.php">
                        <i class="bi bi-shield-lock"></i>
                        Admin
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/web/admin/login.php" class="btn login-btn ms-lg-3">Login / Register</a>
                </li>
                <li class="nav-item">
